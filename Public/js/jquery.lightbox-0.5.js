	...
	$.fn.lightBox = function(settings) {
		...
		function _show_image_data() {
			...
			if ( settings.imageArray.length > 1 ) {
				...
				$('#lightbox-image-details-currentNumber').html("<a href='http://www.guanz.com/My/detail?actionID="+ids[settings.activeImage + 1]+"' target='_blank'>"+ques[settings.activeImage + 1]+"</a>").show();
			}		
		}
		/**
