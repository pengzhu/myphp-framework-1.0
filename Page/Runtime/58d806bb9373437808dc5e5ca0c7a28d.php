...
<h1>
	...
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 编辑活动图片 </span>
</h1>
<!-- 商品搜索 -->
<div align="center">
	...
	<table cellpadding="0" cellspacing="0" id="addgoods" border="1">
		...
		<tr>
			<td colspan="3">
				...
				<form action="join_pic_edit.html" method="post" name="addgoods">
				...
				<input type="hidden" name="event_id" value="<?=$model['event_id']?>" />
					<table cellpadding="5" cellspacing="5" id="tab">
						<tr>
							...
							<td align="left">
							<input type="text" id="thumbpic" name="thumbpic" value="<?=$model['thumbpic']?>"> (尺寸：254 * 130)<br>
