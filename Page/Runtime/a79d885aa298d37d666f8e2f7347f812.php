...
<h1>
	...
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 添加竞拍活动
</span>
</h1>
<!-- 商品搜索 -->
<div align="center">
	...
	<table cellpadding="0" cellspacing="0" id="addgoods" border="1">
		...
		<tr>
			<td colspan="3">
				...
				<form action="auction_add.html" method="post" name="addgoods">
				<input type="hidden" name="post" value="post" />
					<table cellpadding="5" cellspacing="5" id="tab">
						...
						<tr>
							...
							<td align="left">
							<input type="text" name="huohao" value="">
							</td>
						</tr>
						<tr>
							<td align="right">球鞋尺码：</td>
							<td align="left">
							<input type="text" name="chima" value="">
							</td>
						</tr>
						<tr>
