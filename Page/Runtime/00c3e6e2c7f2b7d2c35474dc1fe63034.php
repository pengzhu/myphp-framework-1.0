...
<h1>
	<span class="action-span"><a href="auction_list.html">竞拍活动列表</a></span>
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 竞拍活动编辑 </span>
</h1>
<!-- 商品搜索 -->
<div align="center">
	...
	<table cellpadding="0" cellspacing="0" id="addgoods" border="1">
		...
		<tr>
			<td colspan="3">
				...
				<form action="auction_edit.html" method="post" name="addgoods">
				...
				<input type="hidden" name="post" value="post" />
					<table cellpadding="5" cellspacing="5" id="tab">
						...
						<tr>
							...
							<td align="left">
							<input type="text" id="recpic" name="recpic" value="<?=$model['recpic']?>"> (尺寸：450 * 140)<br>
						...
						<tr>
							...
							<td align="left">
							<input type="text" id="focuspic" name="focuspic" value="<?=$model['focuspic']?>"> (尺寸：668 * 351)<br>
						...
						<tr>
							<td align="right">球鞋货号：</td>
							<td align="left">
							<input type="text" name="huohao" value="<?=$model['huohao']?>">
							</td>
						</tr>
						<tr>
							<td align="right">球鞋尺码：</td>
							<td align="left">
							<input type="text" name="chima" value="<?=$model['chima']?>">
							</td>
						</tr>
						<tr>
							<td align="right">球鞋原价：</td>
							<td align="left">
							<input type="text" name="oldprice" value="<?=$model['oldprice']?>">
							</td>
						</tr>
						<tr>
							<td align="right">竞拍底价：</td>
							<td align="left">
							<input type="text" name="newprice" value="<?=$model['newprice']?>">
							</td>
						</tr>
						<tr>
				...
				<div class="goods3" style="display:none;">
					<table cellpadding="2" cellspacing="2" id="tab">
						<tr>
							...
							<td align="left"><input type="text" id="pic1" name="pic1" value="<?=$imglist[0]['pic']?>"></td>
						...
						<tr>
							...
							<td align="left"><input type="text" id="pic2" name="pic2" value="<?=$imglist[1]['pic']?>"></td>
						...
						<tr>
							...
							<td align="left"><input type="text" id="pic3" name="pic3" value="<?=$imglist[2]['pic']?>"></td>
						...
						<tr>
							...
							<td align="left"><input type="text" id="pic4" name="pic4" value="<?=$imglist[3]['pic']?>"></td>
						...
						<tr>
							...
							<td align="left"><input type="text" id="pic5" name="pic5" value="<?=$imglist[4]['pic']?>"></td>
