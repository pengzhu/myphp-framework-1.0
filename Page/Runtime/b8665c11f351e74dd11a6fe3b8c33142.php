...
<h1>
	<span class="action-span"><a href="add.html">添加名人信息</a></span>
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 名人堂列表 </span>
</h1>
<!-- 商品搜索 -->
<div class="form-div">
	...
	<table cellpadding="3" cellspacing="1">
		...
		<?
			foreach($list as $val)
			{
				...
				echo "<tr><td>".$val['id']."</td><td>".$val['recpic']."</td><td>".$val['title']."</td><td>".$isrec."</td><td>".$ishot."</td><td>".$statu."</td><td><a href='#'>查看</a> / <a href='edit.html?id=".$val['id']."'>修改</a> / <a href='del.html?id=".$val['id']."'>删除</a></td></tr>";
			}
		?>
		<tr>
			<td colspan="7">
