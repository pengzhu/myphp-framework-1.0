		...
		<div class="star_l">
			<div class="star_inside">
				<div class="star_content">
					...
					<div class="d">
						<h4 style="margin-top:10px;"><?=$model['addDate']?> | 作者：<?=($model['author']==""?"isize":$model['author'])?></h4>
					...
					<br />
					<!--<div class="img"><img src="/Public/img/star_img.jpg" /></div>-->
				...
				<div class="star_rTc">
					...
					<div class="c">
						<ul>
							<?foreach($list as $val){?>
							<li>
								<div class="c1"><a href="/Topics/star.html?id=<?=$val['id']?>"><img src="<?=$val['recpic']?>" /></a></div>
								<div class="c2"><a href="/Topics/star.html?id=<?=$val['id']?>"><?=$val['title']?></a></div>
							</li>
							<?}?>
