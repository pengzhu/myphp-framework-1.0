				...
				<div class="visual_photo">
					<ul>
						<li>
							...
							<p class="pli2"><a href="#"><img src="<?=$recphoto1['src']?>" /></a></p>
						</li>
						<li class="lipho">
							<?$i=1;
							foreach($hotphotolist1 as $val){?>
							<div <?if($i==1){echo 'class="divpho"';}?>><img src="<?=$val['thumb_src']?>" width="100%" /></div>
							<?$i=2;}?>
				...
				<div class="visual_photo">
					<ul>
						<li>
							...
							<p class="pli2"><a href="#"><img src="<?=$recphoto2['src']?>" /></a></p>
						</li>
						<li class="lipho">
							<?$i=1;
