...
<h1>
	<span class="action-span"><a href="cate_add.html">添加新类别</a></span>
...
<div class="list-div" id="listDiv">
	<table cellpadding="3" cellspacing="1">
		...
		<?foreach($list as $val){?>
		<tr>
			<td><?=$val['id']?></td><td><?=$val['style_name']?></td><td><a href="cate_edit?id=<?=$val['id']?>">修改</a> <a href="cate_del?id=<?=$val['id']?>">删除</a></td>
		</tr>
		<?}?>
		<tr>
			<td colspan="3">
