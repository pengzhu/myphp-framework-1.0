...
<h1>
	<span class="action-span"><a href="cate_list.html">球鞋性别展区</a></span>
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 添加新性别 </span>
</h1>
<!-- 商品搜索 -->
<div align="center">
	...
	<table cellpadding="0" cellspacing="0" id="addgoods" border="0">
		...
		<tr>
			<td colspan="3">
				...
				<form action="sex_edit.html" method="post" name="addgoods">
				<input type="hidden" name="id" value="<?=$model['id']?>" />
				<input type="hidden" name="post" value="post" />
					<table cellpadding="5" cellspacing="5" id="tab">
						<tr>
							<td align="right">性别名称：</td>
							<td align="left">
							<input type="text" name="sex_name" value="<?=$model['sex_name']?>">
							</td>
						</tr>
						<tr>
