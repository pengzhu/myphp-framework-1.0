...
<h1>
	<span class="action-span"><a href="nlist.html">厂商活动列表</a></span>
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 添加厂商活动
</span>
</h1>
<!-- 商品搜索 -->
<div align="center">
	...
	<table cellpadding="0" cellspacing="0" id="addgoods" border="1">
		...
		<tr>
			<td colspan="3">
				...
				<form action="add.html" method="post" name="addgoods">
