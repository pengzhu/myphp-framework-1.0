...
<h1>
	...
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 投票日志列表 </span>
</h1>
<!-- 商品搜索 -->
<div class="form-div">
...
<div class="list-div" id="listDiv">
	<table cellpadding="3" cellspacing="1">
		...
		<?
			foreach($list as $val)
			{
				echo "<tr><td>".$val['id']."</td><td>".$val['email']."</td><td>".$val['nickname']."</td><td>".$val['mobile']."</td><td>".$val['dt']."</td><td>".$val['ip']."</td></tr>";
			}
		?>
		<tr>
			<td colspan="6">
			<?$page->pagehtml("option_id=".$option_id);?>
			</td>
		</tr>
	</table>
</div>
