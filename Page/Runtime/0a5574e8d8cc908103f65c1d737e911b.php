...
<style>
.a { float:left; margin:10px; width:160px; height:230px; border:1px solid #cccccc; text-align:left; }
...
<h1>
	<span class="action-span"><a href="add">发布新Photo</a></span>
...
<div class="list-div" id="listDiv">
	<table cellpadding="3" cellspacing="1">
		...
		<tr>
			...
			<?foreach($list as $val){?>
			<div class="a">
				<img src="<?=$val['thumb_src']?>" width="160" height="107" />
				<br><span style="font-size:12px; font-weight:bold; color:#000">&nbsp;<?=$val['title']?></span>
