...
<h1>
	<span class="action-span"><a href="nlist.html">球鞋球星列表</a></span>
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 球鞋球星编辑 </span>
</h1>
<!-- 商品搜索 -->
<div align="center">
	...
	<table cellpadding="0" cellspacing="0" id="addgoods" border="1">
		...
		<tr>
			<td colspan="3">
				...
				<form action="edit.html" method="post" name="addgoods">
				...
				<input type="hidden" name="post" value="post" />
					<table cellpadding="5" cellspacing="5" id="tab">
						...
						<tr>
							...
							<td align="left">
							<input type="text" name="smalltitle" value="<?=contentEncode($model['smalltitle'])?>">
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="left">
							<input type="text" name="place" value="<?=contentEncode($model['place'])?>">
							</td>
						</tr>
						<tr>
