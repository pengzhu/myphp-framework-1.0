...
<h1>
	...
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 投票活动编辑 </span>
</h1>
<!-- 商品搜索 -->
<div align="center">
	...
	<table cellpadding="0" cellspacing="0" id="addgoods" border="1">
		...
		<tr>
			<td colspan="3">
				...
				<form action="vote_edit.html" method="post" name="addgoods">
				...
				<input type="hidden" name="post" value="post" />
					<table cellpadding="5" cellspacing="5" id="tab">
						...
						<tr>
							...
							<td align="left">
							<input type="text" name="lottery_dt" value="<?=$model['lottery_dt']?>">
							</td>
						</tr>
						<tr>
							<td align="right">公布时间：</td>
							<td align="left">
							<input type="text" name="publish_dt" value="<?=$model['publish_dt']?>">
							</td>
						</tr>
						<tr>
