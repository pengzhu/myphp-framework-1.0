		...
		<div class="buyOrderConfirmation_bg">
			<table class="tba">
				...
				<tr>
					...
					<td><div><input type="text" id="calculate3" maxlength="4" onchange="cal()" value="1" /></div></td>
					<td>X</td>
			...
			<ul>
				...
				<li><a href="#"></a></li>
				<li class="orderlid">
					<a href="javascript:order_make();"></a>
				</li>
			</ul>
		</div>
	</div>
	<form id="orderform" method="post" action="/Shopping/order_make">
	<input type="hidden" name="shoe_id" value="<?=$model['id']?>" />
	<input type="hidden" id="shoe_num" name="shoe_num" value="1" />
	</form>
	<!--buyContent-->
