...
<div class="login_user">
	...
	<div class="right">
		<form action="/Admin/cate.html" method="post" name="login">
		<table>
			<tr>
				<td>管理员帐号：</td>
			...
			<tr>
				<td>验证码：</td>
				<td><input type="text" class="yzm" name="code" /> <img src="#" width="80" height="20" align="absmiddle" /></td>
			</tr>
			<tr>
				<td colspan="2"><input type="checkbox" class="store" name="store" value="store" /> 请保存我这次的登录信息。</td>
			</tr>
			<tr>
				<td colspan="2"><input type="button" value="登录" class="sub" onclick="abc()" /> <a href="#">忘记密码？</a></td>
			</tr>
		</table>
		</form>
	</div>
