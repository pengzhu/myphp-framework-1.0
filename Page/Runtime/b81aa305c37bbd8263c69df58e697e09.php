...
<div class="nbody">
	...
	<div class="ntag">
		<ul>
			...
			<li><a href="/Index/search?_c=News&_s=Nike">Nike</a></li>
			<li><a href="/Index/search?_c=News&_s=sneaker">sneaker</a></li>
			<li><a href="/Index/search?_c=News&_s=Converse">Converse</a></li>
			<li><a href="/Index/search?_c=News&_s=LeBron">LeBron</a></li>
		</ul>
	</div>
	<!--tag-->
	<!--news_index-->
				...
				<div class="news_rImg">
					...
					foreach($hotnews as $val){?>
						<li <?if($i>1){ echo "class='lia'";}?>>
							<div class="ac"><a onclick="showcontent(<?=$val['id']?>)"><img src="<?=$val['recpic']?>" width="100%" /></a></div>
