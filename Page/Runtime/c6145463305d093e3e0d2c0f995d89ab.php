				...
				<input type="hidden" name="post" value="post" />
					<table cellpadding="5" cellspacing="5" id="tab">
						<tr>
							...
							<td align="left">
							<input type="text" name="shoe_name" value="">
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="left">
							<input type="text" id="shoe_pic" name="shoe_pic" value=""> (尺寸：107 * 95)<br>
						...
						<tr>
							...
							<td align="left">
							<div id="series_div">
							<select name="series_id"><option>请选择系列</option></select>
							</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<option value="<?=$val['id']?>"><?=$val['sex_name']?></option>
							<?}?>
							</select>
							</td>
						</tr>
						...
						<tr>
							...
							<td align="left">
							<input type="radio" name="iseval" value="1" class="sb" onclick="showoption(1)">是 
							<input type="radio" name="iseval" value="0" class="sb"  checked="checked" onclick="showoption(2)">否
							<table id="shoeoption" style="display:none;">
							<tr><td>舒适度<input name="option1" class="da" style="width:20px" value="0">
							缓震性<input name="option2" class="da" style="width:20px" value="0">
							裸保护<input name="option3" class="da" style="width:20px" value="0">
							抓地力<input name="option4" class="da" style="width:20px" value="0"></td></tr>
							</table>
							</td>
						</tr>
						<tr>
