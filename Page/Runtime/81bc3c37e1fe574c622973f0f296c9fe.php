		...
		<tr>
			...
			<?
				foreach($value as $c_value){
					echo "<tr><td>".$c_value['loginid']."</td><td>".$c_value['password']."</td><td>".$c_value['permissions']."</td><td>".$c_value['ban']."</td><td>".$c_value['addtimes']."</td><td>".$c_value['logintime']."</td><td><a href='admin_add.html?cate=update&cid=".$c_value['loginid']."'>修改</a> / <a href='admin_remove.html?cid=".$c_value['id']."'>删除</a></td></tr>";
				}
			?>
