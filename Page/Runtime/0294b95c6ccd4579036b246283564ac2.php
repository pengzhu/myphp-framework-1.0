				...
				<form action="add_process.html" method="post" name="addgoods">
					<table cellpadding="5" cellspacing="5" id="tab">
						...
						<tr>
							...
							<td align="left">
							<input type="text" name="keyword" value=""></td>
						</tr>
						<tr>
							<td align="right" valign="top">鞋子ICON：</td>
							<td align="left">
							<input type="text" id="recpic" name="recpic" value=""> (尺寸：217 * 142)<br>
						...
						<tr>
							...
							<td align="left">
							<input type="text" id="focuspic" name="focuspic" value=""> (尺寸：458 * 409)<br>
						...
						<tr>
							...
							<td align="left">
							<textarea name="brief" id="brief" cols="40" rows="5"></textarea></td>
						</tr>
						<tr>
				...
				<div class="goods3" style="display:none;">
					<table cellpadding="2" cellspacing="2" id="tab">
						<tr>
							...
							<td align="left"><input type="text" id="pic1" name="pic1" value=""> (尺寸：748 * 424)</td>
						...
						<tr>
							...
							<td align="left"><input type="text" id="pic2" name="pic2" value=""> (尺寸：748 * 424)</td>
						...
						<tr>
							...
							<td align="left"><input type="text" id="pic3" name="pic3" value=""> (尺寸：748 * 424)</td>
						...
						<tr>
							...
							<td align="left"><input type="text" id="pic4" name="pic4" value=""> (尺寸：748 * 424)</td>
						...
						<tr>
							...
							<td align="left"><input type="text" id="pic5" name="pic5" value=""> (尺寸：748 * 424)</td>
						...
						<tr>
							...
							<td align="left"><input type="text" id="pic6" name="pic6" value=""> (尺寸：748 * 424)</td>
							<td align="left"><iframe frameborder="0" scrolling="no" src="/Web/Public/upload?path=/Upload/News/Rel/&script=pic6" width="300" height="30"></iframe></td>
						</tr>
						<tr>
							<td align="right">图片七：</td>
							<td align="left"><input type="text" id="pic7" name="pic7" value=""> (尺寸：748 * 424)</td>
							<td align="left"><iframe frameborder="0" scrolling="no" src="/Web/Public/upload?path=/Upload/News/Rel/&script=pic7" width="300" height="30"></iframe></td>
						</tr>
						<tr>
							<td align="right">图片八：</td>
							<td align="left"><input type="text" id="pic8" name="pic8" value=""> (尺寸：748 * 424)</td>
							<td align="left"><iframe frameborder="0" scrolling="no" src="/Web/Public/upload?path=/Upload/News/Rel/&script=pic8" width="300" height="30"></iframe></td>
						</tr>
						<tr>
							<td align="right">图片九：</td>
							<td align="left"><input type="text" id="pic9" name="pic9" value=""> (尺寸：748 * 424)</td>
							<td align="left"><iframe frameborder="0" scrolling="no" src="/Web/Public/upload?path=/Upload/News/Rel/&script=pic9" width="300" height="30"></iframe></td>
						</tr>
						<tr>
							<td align="right">图片十：</td>
							<td align="left"><input type="text" id="pic10" name="pic10" value=""> (尺寸：748 * 424)</td>
							<td align="left"><iframe frameborder="0" scrolling="no" src="/Web/Public/upload?path=/Upload/News/Rel/&script=pic10" width="300" height="30"></iframe></td>
						</tr>
						<tr>
