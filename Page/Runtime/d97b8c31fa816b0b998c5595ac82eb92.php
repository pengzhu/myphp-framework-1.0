...
<h1>
	<span class="action-span"><a href="nlist.html">名人堂列表</a></span>
	<span class="action-span1"><a href="">管理中心</a> </span><span id="search_id" class="action-span1"> - 增添名人信息 </span>
</h1>
<!-- 商品搜索 -->
<div align="center">
				...
				<form action="add_process.html" method="post" name="addgoods">
					<table cellpadding="5" cellspacing="5" id="tab">
						...
						<tr>
							...
							<td align="left">
							<input type="text" id="recpic" name="recpic" value=""> (尺寸：233 * 149)<br>
